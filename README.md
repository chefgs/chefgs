## 👋 Hello Everyone, I'm Saravanan Gnanaguru!
...
- 💻 Polyglot Programmer | DevSecOps Architect | Platform Engineer | AI Tools Builder
- 🤖 Building AI-driven DevOps automation platforms and **MCP Servers** using LLMs (OpenAI, Gemini, Claude, NVIDIA NIM)
- 🦀 Exploring Rust for systems-level tooling alongside Go, Python, Java & JavaScript
- ✍️ Technical Blogger & Speaker — writing and presenting on DevOps, Cloud, and AI topics
- 🌐 Portfolio: <a href="https://www.gsaravanan.dev/" target="_blank">gsaravanan.dev</a> · <a href="https://www.gsaravanan.com/" target="_blank">gsaravanan.com</a>
...
- 🔌 **MCP Server Development** — Exposing DevOps automation tools as native AI skills for Claude, ChatGPT, and other LLM clients via the Model Context Protocol
- 🧪 **AI Tooling & Research** — Experimenting with NVIDIA NIM, Claude, and AI-first product development workflows
...
- 🐳 **Containers & Orchestration** — Kubernetes, Docker, Helm, ArgoCD, Flux CD, and GitOps workflows
...
![Flux CD](https://img.shields.io/badge/Flux%20CD-5468FF?style=flat-square&logo=flux&logoColor=white)
...
![MCP](https://img.shields.io/badge/MCP%20Server-7C3AED?style=flat-square&logo=anthropic&logoColor=white)
...
<picture>
  <source
    srcset="https://github-stats-extended.vercel.app/api/top-langs/?username=chefgs&langs_count=4&theme=dark_github"
    media="(prefers-color-scheme: dark)"
  />
  <img src="https://github-stats-extended.vercel.app/api/top-langs/?username=chefgs&langs_count=4&theme=light_github" alt="Top Langs" />
</picture>
